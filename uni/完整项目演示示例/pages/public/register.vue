	...
	<view>
		...
		<view class="zai-box">
			...
			<view class="zai-form">
				...
				<button class="zai-btn" @click="reg" :disabled="submitBtnDis" :loading="submitBtnDis">立即注册</button>
		...
		methods: {
			...
			async reg() {
				try {
					...
					let userInfo = await this.$apis.GetMethodModel("RegMember", this.reqBody);

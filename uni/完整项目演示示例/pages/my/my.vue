	...
	<view>
		<view class="header">
			<view class="bg">
				<view class="box">
					<view class="box-hd">
						<view class="avator icon">
							<image :src="this.src"></image>
						</view>
						<view class="phone-number">{{userinfo.name}}</view>
					</view>
					<view class="box-bd">
						<view class="item">
							<view class="icon">
								<image src="@/static/user/message.png"></image>
							</view>
							<view class="text">我的通知</view>
						</view>
						<view class="item">
							<navigator url="userShare" hover-class="none" class="zai-label">
								<view class="icon" style="margin: auto;">
									<image src="@/static/user/favorite.png"></image>
								</view>
		...
		<view class="list-content">
			...
			<view class="list">
				<view class="li" style="background: #fa436a;" @click="logout">
					<view class="text" style="text-align: center;font-size: 20px;color: white;">退出</view>
				</view>
			</view>
...
<script>
	...
	export default {
		...
		onLoad() {
			...
			if (this.userinfo.src != undefined && this.userinfo.src !="") {
				this.src = this.userinfo.src;
			}

<template>
	<view class="base-cloud" v-if="isShow">
		<view class="fixed z20 flex ct" :class="{'wp' : showWrapper}" :animation="inData">
			
			<view  class="whiteBg rds5 shadow father hidden scaleIn" :style="{width : width , height : height }" style="padding-top: 42px;">

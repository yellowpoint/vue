		...
		<view class="base-cloud">
			<view class="fixed">
				...
				<view class="abs flex ct">
					<view class="w1200 h700 rds25  shadow flex ">
						<view class="w50p h100p blackBg rdsBl23 rdsTl23 father">
						...
						<view class="w50p h100p whiteBg rdsBr23 rdsTr23 flex ct pb100">
							<form @submit="submit" data-action="admin/user/login" class="w60p">

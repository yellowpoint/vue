<template>
	<layout :loading="loading" pageKey="operateLog" title="操作日志">
		...
		<block slot="titleLeft">
			<conditions :showCount="2" :conditions="conditions" :list="conditonList" @confirm="submitSearch"></conditions>
		</block>
...
<script>
	export default {
		data() {
			return {
				conditonList:[
					{title:"时间",name:"createTimeStart", endName:"createTimeEnd", type:"time" , timeType : "rangetime"  },

...
;(function() {
	//vconsole 手机上模拟的控制台
	AlloyLever.config({
		cdn:'https://cdn.bootcss.com/vConsole/3.2.0/vconsole.min.js',
		entry: ".marqueeTips,.loginImg,.headerInfo" //点击这个DOM元素6次 弹出控制台
	})
	...
	// 在微信中使用
	if(isOpenInWeixin()) {
		wxShare('答题挑战赢红包', location.href, 'http://idt.51app.cn/static/img/shareImg.jpg', '我已领取，一起来玩！')
	}
